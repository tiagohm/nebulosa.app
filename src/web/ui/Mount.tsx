...
export const Mount = memo(() => {
	...
	const { mount: { connected, tracking, slewing, parking, parked, trackModes, trackMode, slewRates, slewRate, canAbort, canPark, canHome, equatorialCoordinate }, connecting, targetCoordinate, currentCoordinate } = useSnapshot(mount.state)
						...
						<ModalBody>
							<div className='mt-0 grid grid-cols-12 gap-2'>
								...
								<DropdownButton
									...
									<DropdownItem key='goto' startContent={<Lucide.Telescope size={16} />}>
										Go To
									</DropdownItem>
									<DropdownItem key='slew' startContent={<Lucide.Telescope size={16} />}>
										Slew
									</DropdownItem>
									<DropdownItem key='sync' startContent={<Lucide.RefreshCw size={16} />}>
										Sync
									</DropdownItem>
									<DropdownItem key='frame' startContent={<Lucide.Image size={16} />}>
										Frame
									</DropdownItem>
								</DropdownButton>
