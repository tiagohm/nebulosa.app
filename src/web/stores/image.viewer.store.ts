...
import { imageAdjustmentStore, type ImageAdjustmentStore } from '@stores/image.adjustment.store'
...
import { imageScnrStore, type ImageScnrStore } from '@stores/image.scnr.store'
import { imageSettingsStore, type ImageSettingsStore } from '@stores/image.settings.store'
import { imageSolverStore, type ImageSolverStore } from '@stores/image.solver.store'
import { imageStarDetectionStore, type ImageStarDetectionStore } from '@stores/image.stardetection.store'
import { imageStatisticsStore, type ImageStatisticsStore } from '@stores/image.statistics.store'
import { imageStretchStore, type ImageStretchStore } from '@stores/image.stretch.store'
