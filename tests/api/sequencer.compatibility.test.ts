...
const CONSUMED = [
	...
	'target.center.capture.exposureTimeUnit',
	...
	'capture.frames[].capture.frameType',
	'capture.frames[].capture.exposureTime',
	'capture.frames[].capture.exposureTimeUnit',
	'capture.frames[].capture.binX',
	'capture.frames[].capture.binY',
	'capture.frames[].capture.gain',
	'capture.frames[].capture.offset',
	'capture.frames[].capture.frameFormat',
	'capture.frames[].capture.transferFormat',
	'capture.frames[].capture.compressed',
	'capture.frames[].capture.subframe',
	'capture.frames[].capture.x',
	'capture.frames[].capture.y',
	'capture.frames[].capture.width',
	'capture.frames[].capture.height',
	'capture.frames[].capture.filter.type',
	'capture.frames[].capture.filter.name',
	...
	'autofocus.capture.exposureTimeUnit',
