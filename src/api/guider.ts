...
import { exposureTimeInSeconds } from 'src/types/camera'
import { DEFAULT_GUIDER_DITHER, DEFAULT_GUIDER_EVENT } from 'src/types/guider'
import type { GuiderConnect, GuiderDither, GuiderEvent, GuiderState, GuiderStatus } from 'src/types/guider'
