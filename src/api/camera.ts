...
import { type CameraFrameEvent, type CameraCaptureEvent, type CameraCaptureStart, DEFAULT_CAMERA_CAPTURE_EVENT } from 'src/types/camera'
import type { CameraAdded, CameraRemoved, CameraUpdated } from '../shared/types'
