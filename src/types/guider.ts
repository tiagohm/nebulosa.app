...
export interface GuiderSessionInfo {
	// Stable identifier of the session, derived from the target it occupies rather than from the transport
	// socket. Reconnecting the same host:port or the same device pair keeps this name.
	readonly id: string
