...
export function coordinateInfo(time: Time, longitude: Angle, target: EquatorialCoordinate | MountTargetCoordinate<string | Angle>, flags: CoordinateInfoFlags = DEFAULT_COORDINATE_INFO_FLAGS) {
	...
	// J2000 equatorial coordinate
		...
		hasEquatorial ||= flags.ecliptic === true || flags.horizontal === true || flags.constellation === true || flags.lst === true
	...
	// Local horizontal coordinate
		...
		hasEquatorial ||= flags.equatorialJ2000 === true || flags.ecliptic === true || flags.galactic === true || flags.constellation === true || flags.lst === true
	...
	// Ecliptic (at date) coordinate
		...
		hasEquatorial ||= flags.equatorialJ2000 === true || flags.horizontal === true || flags.galactic === true || flags.constellation === true || flags.lst === true
