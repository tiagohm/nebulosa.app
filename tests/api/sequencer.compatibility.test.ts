...
const CONSUMED = [
	...
	'target.center.everyFrames',
	'target.center.everyTime',
...
const REJECTED: readonly Classified[] = [
	...
	{ root: 'target.center.recenterAfterDrift', path: 'target.center.recenterAfterDrift', declare: (d) => ({ ...d, target: { ...d.target, center: { ...d.target.center, recenterAfterDrift: true } } }) },
