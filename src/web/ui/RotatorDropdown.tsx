...
export interface RotatorDropdownProps extends Omit<DeviceDropdownProps<Omit<Rotator, symbol>>, 'items' | 'icon' | 'children'> {
...
export const RotatorDropdown = memo(({ showLabel = true, showLabelOnEmpty = true, value, onValueChange, children, buttonProps, ...props }: RotatorDropdownProps) => {
	...
	const rotators = useSnapshot(equipment.state.ROTATOR)
	...
	return (
		<DeviceDropdown {...props} items={rotators} onValueChange={handleValueChange} value={value}>
