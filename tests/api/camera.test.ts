...
import type { CameraAdded, CameraRemoved, CameraUpdated } from 'src/shared/types'
import { DEFAULT_CAMERA_CAPTURE_START } from 'src/types/camera'
import type { CameraCaptureEvent, CameraCaptureStart, CameraDither, CameraFrameEvent } from 'src/types/camera'
import { DEFAULT_GUIDER_EVENT } from 'src/types/guider'
