...
export namespace Icons {
	export const Counter = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
	...
	export const TimerSand = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' width={size} {...props}>
	...
	export const TimerSandComplete = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' width={size} {...props}>
	...
	export const Camera = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
	...
	export const Telescope = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Focuser = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Thermometer = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Save = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const SaveOff = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FolderOff = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Link = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Heart = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Sun = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Moon = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Stop = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Play = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Check = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Fullscreen = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Circle = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Image = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Sync = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Home = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const HomeSearch = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const HomeMapMarker = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Galaxy = memo(({ size = 18, stroke = 2, color = 'currentColor', ...props }: IconProps) => {
		return (
	...
	export const Plus = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Laptop = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Clock = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Edit = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Copy = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Trash = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const VerticalMenu = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Sigma = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Restore = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Reload = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Planet = memo(({ size = 18, stroke = 2, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill='none' height={size} stroke={color} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Search = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ChevronLeft = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ChevronRight = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ChevronDown = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ChevronUp = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Filter = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowUp = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowLeft = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FolderPlus = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FolderOpen = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Folder = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const File = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FolderRoot = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const CloseCircle = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Cog = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Menu = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Close = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MapMarker = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Download = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Satellite = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Connect = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ZoomIn = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ImagePlus = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const WandSparkles = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Meteor = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MousePointerClick = memo(({ size = 18, stroke = 2, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill='none' height={size} stroke={color} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
				<path d='M14 4.1 12 6' />
				<path d='m5.1 8-2.9-.8' />
	...
	export const Crosshair = memo(({ size = 18, stroke = 2, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill='none' height={size} stroke={color} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Pen = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Palette = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Grid = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FlipHorizontal = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FlipVertical = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const BringToFront = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Stars = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Box = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Focus = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const InvertColor = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Swatch = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Histogram = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Text = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Chart = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ImageEdit = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const FilterWheel = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Brush = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Broom = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowDown = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowRight = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowUpRight = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowUpLeft = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowDownLeft = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ArrowDownRight = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Tune = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Server = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ServerOff = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Lock = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const LockOpen = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Send = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const CalendarToday = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const TimerPause = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const TimerPlay = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const RemoteControl = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Info = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Leaf = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const SnowFlake = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Flower = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const OpenInNew = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MoonFull = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MoonNew = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MoonLastQuarter = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MoonFirstQuarter = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Monitor = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const MonitorLock = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Pin = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Cursor = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const ViewList = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Message = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Radar = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
	...
	export const Pulse = memo(({ size = 18, stroke = 1, color = 'currentColor', ...props }: IconProps) => {
		return (
			<svg fill={color} height={size} strokeWidth={stroke} viewBox='0 0 24 24' {...props}>
